...
if TEMPLATE_PATH.exists():
    ...
    ui.render_template_section(rendered_code, template_method)
    ...
    if ui.render_colab_button(has_colab_cfg):
        try:
            with st.spinner("Uploading notebook to GitHub..."):
                st.session_state[colab_key] = notebook_service.upload_notebook_and_get_colab_url(
    ...
    if colab_url:
        ui.render_colab_link(colab_url)
else:
